...
public class BeerControllerTest {
    ...
    @Test
    void quandoPOSTForChamadoCrieUmaCervejaERetorneCreateStatus() throws Exception {
        //given
    ...
    @Test
    void quandoPOSTForChamadoEAlgumCampoEstiverNuloUmErroDeveSerRetornado() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoGETForChamadoComUmNomePassadoRetorneOkStatus() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoGETForChamadoComUmNomePassadoEUmaCervejaNaoForEncontradaRetorneNotFoundStatus() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoGETListaDeCervejasForChamadaRetorneOkStatus() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoDELETEForChamadoComUmIDValidoRetorneNoContentStatus() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoPATCHForChamadoParaIncrementarDeveRetornarOkStatus() throws Exception {
    ...
    @Test
    void quandoPATCHForChamadoParaIncrementarEForMaiorQueOMaximoDeveRetornarBadRequestStatus() throws Exception {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(30)
                .build();
    ...
    @Test
    void quandoPATCHForChamadoParaIncrementarComIDInvalidoDeveRetornarNotFoundStatus() throws Exception {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(30)
                .build();
